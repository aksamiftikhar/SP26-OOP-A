...
public class Car {
    ...
    public static void main(String[] args) {
        ...
        lecture08.Car[] cArr = new lecture08.Car[3];
        cArr[0] = new lecture08.Car();
        cArr[1] = new lecture08.Car(2025);
        cArr[2] = new lecture08.Car(2026);

        lecture08.Car[] cArr2 = { new lecture08.Car(), new lecture08.Car(2025) };
